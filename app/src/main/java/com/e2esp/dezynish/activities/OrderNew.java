...
import com.e2esp.dezynish.models.orders.MetaItem;
import com.e2esp.dezynish.models.orders.Order;
import com.e2esp.dezynish.models.orders.OrderResponse;
import com.e2esp.dezynish.models.orders.OrderUpdate;
import com.e2esp.dezynish.models.orders.OrderUpdateValues;
import com.e2esp.dezynish.models.orders.PaymentDetails;
import com.e2esp.dezynish.models.orders.ShippingLine;
...
public class OrderNew extends AppCompatActivity {
    ...
    private void refreshView() {
        ...
        String query = DezynishContract.ProductEntry.COLUMN_ID + " IN (" + TextUtils.join(", ", parameters) + ")";
        ...
        for (final Item item : mOrderSelected.getItems()) {
            ...
            child.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String query = DezynishContract.ProductEntry.COLUMN_SKU + " == ?" ;
