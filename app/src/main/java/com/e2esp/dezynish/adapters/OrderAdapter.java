...
public class OrderAdapter extends CursorRecyclerViewAdapter<OrderAdapter.ViewHolder>  {
    ...
    public void onBindViewHolder(ViewHolder holder, Cursor cursor) {
        String json = cursor.getString(cursor.getColumnIndexOrThrow(DezynishContract.OrdersEntry.COLUMN_JSON));
        String timestampCreatedAt = cursor.getString(cursor.getColumnIndexOrThrow(DezynishContract.OrdersEntry.COLUMN_CREATED_AT));
