package com.e2esp.dezynish.services;
        ...
        if(intent != null){
            ...
            */
            ...
            String[] projectionCustomer = {
                    DezynishContract.CustomerEntry.COLUMN_JSON,
            };
            String selectionCustomer = DezynishContract.CustomerEntry.COLUMN_SHIPPING_PHONE+ " LIKE ? OR  " +
                    DezynishContract.CustomerEntry.COLUMN_BILLING_PHONE + " LIKE ?" ;
            String[] selectionCustomerArgs = new String[]{ "%"+search+"%",
                    "%"+search+"%"};

            Cursor cursorCustomer = getContentResolver().query(DezynishContract.CustomerEntry.CONTENT_URI,
                    projectionCustomer,
                    selectionCustomer,
                ...
                if(cursorCustomer.moveToFirst()) {
                    do {
                        ...
                        if(json!=null){
                            ...
                            String selectionOrderByCustomer = DezynishContract.OrdersEntry.COLUMN_CUSTOMER_ID + " = ?" ;
                            String[] selectionOrderByCustomerArgs = new String[]{ String.valueOf(customer.getId()) };
                            Cursor cursorOrderByCustomer = getContentResolver().query(DezynishContract.OrdersEntry.CONTENT_URI,
                                    projectionOrders,
